...
- Indicators: 11 cards (5 USD quotes, riesgo país, IPC mensual, reservas, BADLAR, Brent, WTI) with per-class TTLs, stale/absent degradation, reference-age guard; sources dolarapi, BCRA v4, ArgentinaDatos (riesgo país + IPC), Yahoo v8 (Brent/WTI), all keyless
